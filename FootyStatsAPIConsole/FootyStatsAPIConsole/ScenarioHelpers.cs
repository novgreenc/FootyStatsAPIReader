...
namespace FootyStatsAPIConsole
{
    ...
    {
        /// <summary>
        /// Helper Method to get all players who were involved in Goals and the necessary context, then writes it to an output CSV
        /// </summary>
        /// <param name="apiKey">Your personal API key as provided by FootyStats</param>
        /// <param name="seasonId">The Id of the season to get the player goals for</param>
        public static void Get_Players_Involved_In_Goals_With_Context(string apiKey, int seasonId)
        {
        ...
        /// <summary>
        /// Helper method to test the APIs
        /// </summary>
        /// <param name="apiKey">Your personal API key as provided by FootyStats</param>
        public static void Test_APIs(string apiKey)
        {
